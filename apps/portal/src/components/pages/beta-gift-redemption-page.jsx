...
const BetaGiftRedemptionPage = () => {
    ...
    if (buyerName && siteTitle) {
        headerText = t('{buyerName} has gifted you a {duration} {tierName} membership to {siteTitle}');
    } else if (siteTitle) {
        headerText = t('You\'ve been gifted a {duration} {tierName} membership to {siteTitle}');
    } else {
        headerText = t('You\'ve been gifted a {duration} {tierName} membership');
    }
